...
- **App**: https://pod-pilot-sandy.vercel.app (Vercel project `pod-pilot`, team `youssefbouchtaoui-4103s-projects`)
...
2. **Mockups** — core flow. Upload or AI-generate a design (Generate/Edit/Remix modes), auto-analysis (style/niche/colors/strength/weakness/keywords), pick garment templates, generate composited mockups, zip download.
...
- **Etsy API integration** (OAuth + draft listing publish): user needs to register an app at etsy.com/developers with callback URL `https://pod-pilot-sandy.vercel.app/api/etsy/callback` and provide the Keystring. Not started — was waiting on this when work paused.
